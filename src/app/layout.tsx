...
export const metadata: Metadata = {
  ...
  title: { default: "Ciel Top Up — Top Up Game Cepat & Aman", template: "%s — Ciel Top Up" },
  description:
  ...
  keywords: ["top up game", "topup ML", "topup mobile legends", "topup genshin", "topup free fire", "qris game", "e-wallet", "voucher game", "ciel top up"],
  robots: { index: true, follow: true },
  icons: { icon: [{ url: "/favicon.ico" }], apple: [{ url: "/apple-touch-icon.png" }], shortcut: [{ url: "/icon.png" }] },
  ...
  openGraph: {
    ...
    description: "Top up game favorit Anda dengan QRIS/E-Wallet/VA. Proses instan & garansi pesanan.",
  ...
  twitter: {
    ...
    title: "Ciel Top Up — Top Up Game Cepat & Aman",
    description: "Top up MLBB, Free Fire, Genshin, HSR, Honor of Kings. Cepat, aman, otomatis.",
    images: ["/og.png"],
    creator: "@ciel_topup",
  },
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="id" className={inter.variable} suppressHydrationWarning>
      <body className="min-h-dvh bg-background text-foreground antialiased selection:bg-indigo-500/20 selection:text-indigo-400">
