      ...
      <div className="grid gap-10 lg:grid-cols-4">
        ...
        <div className="lg:col-span-2">
          ...
          <p className="mt-4 max-w-prose text-sm leading-relaxed text-muted-foreground">
            Top up MLBB, Free Fire, Genshin, HSR, Honor of Kings, dan puluhan game lain.
            Bayar via QRIS, E-Wallet, atau Virtual Account. Proses cepat, aman, dan otomatis.
          </p>
          ...
          <div className="mt-6 flex flex-wrap gap-2">
            {payments.map((p) => (
              <span
                key={p}
                className="rounded-md border border-white/10 bg-neutral-900/40 px-2.5 py-1 text-xs text-foreground/80 ring-1 ring-black/5"
              >
                {p}
              </span>
            ))}
        ...
        <div className="grid grid-cols-2 gap-8 lg:col-span-2">
          ...
          <div className="col-span-2 border-t border-white/5 pt-6 lg:col-span-2">
            ...
            {/* Newsletter (POST ke endpoint backendmu jika ada) */}
            <form
      ...
      <div className="mt-10 border-t border-white/5 pt-6 text-xs text-muted-foreground">
        <div className="flex flex-col items-center justify-between gap-3 sm:flex-row">
          ...
          <p className="text-[11px]">
            *Estimasi proses dapat berbeda tiap game & metode bayar.
          </p>
        </div>
      </div>
    </div>
