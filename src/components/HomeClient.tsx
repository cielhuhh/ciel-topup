...
import { Search, Sparkles, Flame, X, ShieldCheck, BadgeCheck } from "lucide-react";
      ...
      <section className="rounded-2xl border bg-card/80 p-4 backdrop-blur">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-2">
            <div className="inline-flex items-center text-xs opacity-70">
...
>
  ...
  <option className="bg-neutral-900 text-white" value="newest">Terbaru</option>
      ...
      {selected && (
        ...
        >
          <div
            className="w-full max-w-2xl rounded-2xl border bg-card/95 p-4 shadow-2xl"
